...
当前环境没有 Android SDK / Gradle / ADB，无法在这里直接生成 APK。请用 Android Studio 打开 `android/`，选择：
...
Android 工程已包含演示签名证书 `android/app/debug.keystore`，可直接用于本课程/演示 APK 打包，避免 `Missing keystore`。正式发布前请换成自己的私有 release keystore。
